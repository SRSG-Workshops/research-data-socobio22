...
`plot_type`, … are strings\! The behavior is `stringsAsFactors = FALSE` 
is the default. If we set stringsAsFactors to True then these columns will be factors
...
> Assume hindfoot length is currently in mm.
> 
...
Page built on: 📆 2022-11-04 ‒ 🕢 13:56:13
